...
from obs o
  inner join concept_view cv on cv.concept_id=o.concept_id and concept_full_name='Immunization Incident Vaccine'  and o.voided=0
                                ...
                                and o.obs_group_id in(select o.obs_group_id from obs o inner join concept_view cv on o.concept_id = cv.concept_id and cv.concept_full_name = 'Immunization Incident Group,Pregnant'
                                                                                                                     and o.value_coded = 1)
